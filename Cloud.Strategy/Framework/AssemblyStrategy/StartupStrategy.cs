...
namespace Cloud.Strategy.Framework.AssemblyStrategy
{
    public class StartupStrategy : StrategyBase, IStartupStrategy
    {
        ...
        public void StartInitialization()
        {
            ...
            //api配置
            var apimanagerConfig = new LuaConfig(dataConfig.cloudConfig());
            CloudConfig.DataIsolation = apimanagerConfig.Data.dataIsolation;
            CloudConfig.IsDebugger = apimanagerConfig.Data.isDebugger;
